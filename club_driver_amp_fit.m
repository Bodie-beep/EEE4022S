function [fitresult, gof] = club_driver_amp_fit(time_at_peaks, amplitude)
%CREATEFIT1(TIME_AT_PEAKS,AMPLITUDE)
%  Create a fit.
%
%  Data for 'Club_driver_amp_fit' fit:
...
%  Auto-generated by MATLAB on 05-Nov-2020 02:43:57


%% Fit: 'Club_driver_amp_fit'.
...
% Plot fit with data.
figure( 'Name', 'Club_driver_amp_fit' );
h = plot( fitresult, xData, yData );
legend( h, 'Actual', 'Modelled', 'Location', 'NorthEast', 'Interpreter', 'none','FontSize',16);
title("Amplitude Profile of Driver Downswing",'FontSize',16);
% Label axes
